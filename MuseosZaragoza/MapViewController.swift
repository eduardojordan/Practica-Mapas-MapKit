   ...
   @IBOutlet weak var selector: UISegmentedControl!
    ...
    override func viewDidLoad() {
     ...
     //   let userLocation = miMapa.userLocation
        let coordinate = CLLocationCoordinate2D(latitude: 41.653278, longitude:-0.8774)
        ...
        coordTemp.latitude = 41.6552
        coordTemp.longitude = -0.876292
        agregarPin(coordenada : coordTemp, titulo: "Museo del Foro de Caesaraugusta")
        
        var coordTemp2: CLLocationCoordinate2D = CLLocationCoordinate2D()
        coordTemp.latitude = 41.653278
        coordTemp.longitude = -0.8772
        agregarPin(coordenada : coordTemp, titulo : "Museo de las Termas Públicas de Caesaraugusta")
    
        var coordTemp3: CLLocationCoordinate2D = CLLocationCoordinate2D()
        coordTemp.latitude = 41.648205
        coordTemp.longitude = -0.878835
        agregarPin(coordenada : coordTemp, titulo : "Museo de Zaragoza")
        
        var coordTemp4: CLLocationCoordinate2D = CLLocationCoordinate2D()
        coordTemp.latitude = 41.6548
        coordTemp.longitude = -0.882406
        agregarPin(coordenada : coordTemp, titulo : "Museo Pablo Gargallo")
